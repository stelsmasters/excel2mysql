...
// Выбираем кодировку UTF-8 для корректной загрузки данных
$connection->set_charset("utf8");

// Загружаем файл Excel
$PHPExcel_file = PHPExcel_IOFactory::load("upload.xlsx");

// Вызываем функцию, преобразуем ТОЛЬКО ПЕРВЫЙ лист Excel в таблицу MySQL
$PHPExcel_file->setActiveSheetIndex(0);
echo excel2mysql($PHPExcel_file->getActiveSheet(), $connection, "upload", 1) ? "OK!\n" : "FAIL!\n";

// Вызываем функцию, перебираем ВСЕ листы Excel и преобразуем в таблицу MySQL
...
// Функция преобразования данных из экселя в таблицу MySQL
